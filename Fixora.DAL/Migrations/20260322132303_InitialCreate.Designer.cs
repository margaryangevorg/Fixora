...
namespace Fixora.DAL.Migrations
{
    ...
    [Migration("20260322132303_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fixora.DAL.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Fixora.DAL.Entities.Building", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fixora.DAL.Entities.Elevator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fixora.DAL.Entities.MaintenanceOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fixora.DAL.Entities.Elevator", b =>
                {
                    b.HasOne("Fixora.DAL.Entities.Building", "Building")
                        .WithMany("Elevators")
            ...
            modelBuilder.Entity("Fixora.DAL.Entities.MaintenanceOrder", b =>
                {
                    b.HasOne("Fixora.DAL.Entities.AppUser", "AssignedEngineer")
                        .WithMany("AssignedOrders")
                        .HasForeignKey("AssignedEngineerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Fixora.DAL.Entities.Elevator", "Elevator")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Fixora.DAL.Entities.AppUser", null)
                        .WithMany()
