using Fixora.API.Services.Implementations;
using Fixora.API.Services.Interfaces;
using Fixora.DAL.Context;
using Fixora.DAL.Entities;
using Fixora.DAL.Repositories.Implementations;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ElevatorMaintenance API", Version = "v1" });
